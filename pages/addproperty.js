...
<Box p="1rem 3rem 1rem 2rem" display="flex" bg="brand.700" mb="1rem" justifyContent="space-between" >
      ...
      <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack spacing={4} w={'full'} maxW={'md'}>
            ...
            <Stack spacing={6}>
              <Button onClick={() => postProp()} bg="brand.600" color="white" _hover={{ bg: 'brand.700' }} variant={'solid'}>
                Add your property
              </Button>
             <Link href="/" ><Button w="100%" border="1px solid" borderColor="brand.500" textDecoration="none" _hover={{ bg: "brand.50" }} color="brand.700">
                Back to home
              </Button>
              </Link> 
            </Stack>

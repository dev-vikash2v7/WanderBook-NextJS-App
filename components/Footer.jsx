...
const Footer = () => {
  return (
    ...
    <Box bg='brand.800' w='100%' p="2rem" color='white'>
      <Box w='60%' m="auto" p={4} >
     <Text fontSize='3xl' lineHeight="33px" textAlign="center" color="white" fontWeight="300">Start Your Journey Today!</Text>
     <Text fontSize='1xl' textAlign="center" mb="10px" color="gray.300">Sign up and discover amazing travel experiences</Text>
     ...
     <Button borderRadius="3px" m={{sm:"auto" , md:"auto" }}  ml={{lg:"10rem" }} bg="accent.500" color="white" _hover={{ bg: 'accent.600' }}>Subscribe</Button>
     </Grid>
      </Box>
  </Box>
  {/* *****************************************************footer Section 1 end********************************************************** */}
    <Box bg='brand.700' w='100%' color='white'>
...
{/* *****************************************************footer Section 2 end********************************************************** */}
  <Box color="brand.600" w='80%' m="auto" mt="15px" mb="15px">
...
<Box w="70%" m="auto" >
  <Box><Text textAlign="center" fontSize='xs' color="gray" mb="15px" >WanderBook is your trusted companion for discovering amazing destinations and creating unforgettable travel memories.</Text></Box>

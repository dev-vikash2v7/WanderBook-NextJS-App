      ...
      >
        <Box width={"95%"} margin={"auto"}>
          ...
          <Text
            ...
            textAlign={"start"}
          >
            Search for amazing destinations, hotels, and experiences...
          </Text>
        </Box>
      </Box>
      <Box
      ...
      >
        <InputGroup>
          ...
          <Input
            ...
            borderRightColor={"accent.400"}
            height="50px"
            borderRadius={"0px"}
            onChange={({target}) => setInputData(target.value)}
          />
        </InputGroup>
        <Box alignItems={"center"} borderRight={"4px solid"} borderRightColor={"accent.400"} display={"flex"}>
          <DatePicker />          
        </Box>
        {/*  */}
        <Pop />
  ...
  return (
    <Popover>
      ...
      <Portal>
        <PopoverContent>
          <PopoverArrow />
          <PopoverHeader bg="brand.600" color={"white"}>Guest Selection</PopoverHeader>
          <PopoverCloseButton />
